        ...
        <div class="row">
                <div class="col-xl-12 order-xl-1">
                    <div class="card bg-secondary shadow">
                        ...
                        <div class="card-body">
                            <form method="post" id="data-form" action="{{ route('product.store') }}" enctype="multipart/form-data" autocomplete="off">
                                @csrf
                                @method('post')

                                <h6 class="heading-small text-muted mb-4">{{ __('Add Product ') }}</h6>
                                ...
                                <div class="tab-content tab-validate" style="margin-top:20px;">
                                    ...
                                    @include('admin.product.tabs.data')
                                    @include('admin.product.tabs.links')
                                    @include('admin.product.tabs.attribute')
                                    @include('admin.product.tabs.special')
                                    @include('admin.product.tabs.option')
                                    @include('admin.product.tabs.image')
                                </div>
