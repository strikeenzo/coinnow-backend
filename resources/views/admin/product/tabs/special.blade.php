            ...
            <table class="table align-items-center table-flush">
                ...
                <tbody class="list">
                    <tr class="tr_special_clone">
                        <td><input type="text" name="special_price" id="special_price"
                        ...
                        <td><input name="start_date"
                                ...
                                placeholder="Select Start date" type="text" value="{{ old('start_date', '') }}"></td>
                        <td><input name="end_date"
                                class="form-control datepicker {{ $errors->has('end_date') ? ' is-invalid' : '' }}"
                                placeholder="Select End date" type="text" value="{{ old('end_date', '') }}"></td>
                    </tr>
                </tbody>
                <tfoot>
