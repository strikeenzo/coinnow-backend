                ...
                <tbody class="list">
                    @forelse($data['attributeIds'] as $keyAttribute => $valueAttribute)
                        <tr class="tr_attribute_clone">
                            ...
                            <td>
                                <textarea class="form-control" name="attributesArray[{{ $keyAttribute }}][text]" id="attribute_text_{{ $keyAttribute }}"
                                    rows="4">{{ $data['productRelatedAttribute'][$valueAttribute] }}</textarea>
                            </td>
                            <td>
                                <button class="btn btn-danger" type="button" id="DeleteAttributeButton">
