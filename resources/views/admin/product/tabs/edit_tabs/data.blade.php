<div class="tab-pane " id="tab-data">
  ...
  <div class="row">
    ...
    <div class="row">
        <div class="col-md-6 form-group{{ $errors->has('min_price') ? ' has-danger' : '' }}">
            ...
            <input type="text" name="min_price" id="min_price" class="form-control form-control-alternative{{ $errors->has('min_price') ? ' is-invalid' : '' }}" placeholder="{{ __('Min Price') }}" value="{{ old('min_price', $product->min_price) }}" >
        ...
        <div class="col-md-6 form-group{{ $errors->has('max_price') ? ' has-danger' : '' }}">
            ...
            <input type="number" name="max_price" id="max_price" class="form-control form-control-alternative{{ $errors->has('max_price') ? ' is-invalid' : '' }}" placeholder="{{ __('Max Price') }}" value="{{ old('max_price', $product->max_price) }}" >
  ...
  <div class="row">
    <div class="col-md-6 form-group{{ $errors->has('quantity') ? ' has-danger' : '' }}">
        ...
        <input type="number" min="0" name="quantity" id="quantity" value="{{ old('quantity', $product->quantity) }}" class="form-control form-control-alternative{{ $errors->has('quantity') ? ' is-invalid' : '' }}" >
    ...
    <div class="col-md-6 form-group{{ $errors->has('range_quantity') ? ' has-danger' : '' }}">
        ...
        <input type="number" min="0" name="range_quantity" id="range_quantity" value="{{ old('range_quantity', $product->range_quantity) }}" class="form-control form-control-alternative{{ $errors->has('range_quantity') ? ' is-invalid' : '' }}" required>
    ...
    <div class="row">
        <div class="col-md-6 form-group{{ $errors->has('points') ? ' has-danger' : '' }}">
            ...
            <input type="number" min="0" name="points" id="points" value="{{ old('points', $product->points ?? 0) ?? 0 }}" class="form-control form-control-alternative{{ $errors->has('points') ? ' is-invalid' : '' }}" >
        ...
        <div class="col-md-6 form-group{{ $errors->has('change_amount') ? ' has-danger' : '' }}">
            ...
            <input type="number" min="0" name="change_amount" id="change_amount" value="{{ old('change_amount', $product->change_amount ?? 0) }}" class="form-control form-control-alternative{{ $errors->has('change_amount') ? ' is-invalid' : '' }}">
