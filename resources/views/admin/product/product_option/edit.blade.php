                                ...
                                <div class="table-responsive">
                                    <table class="table align-items-center table-flush" id="tbl">
                                        <thead class="thead-dark">
                                            <tr>
                                                <th scope="col" class="sort" data-sort="option_value_name">Option Value
                                                    Name</th>
                                        ...
                                        <tbody class="list">
                                            @forelse($optionValueArray as $key => $value)
                                                <tr class="tr_clone">
                                                    <input type="hidden" name="option_value[id][]"
                                                        value="{{ $value->id }}">
                                                    <td><input type="text" name="option_value[name][]"
                                                            id="name{{ $key }}"
                                                            class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}"
                                                            value="{{ old('name', $value->name) }}" required></td>
                                                    <td>
                                                        <input type="file" name="option_value[image][]"
                                                            id="image{{ $key }}"
                                                            class="hasFile form-control form-control-alternative{{ $errors->has('image') ? ' is-invalid' : '' }}"
                                                            value="{{ old('image', '') }}">
                                                        <a target="_blank"
                                                            href="{{ url(config('constant.file_path.product_option') . "/$value->image") }}">View
                                                            Image</a>
                                                    </td>
                                                    <td class="budget"><input type="number" min="1"
                                                            name="option_value[sort_order][]"
                                                            id="sort_order {{ $key }}"
                                            ...
                                            @empty
                                                <tr class="tr_clone">
                                                    <td><input type="text" name="option_value[name][]" id="name0"
                                                            class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}"
                                                            value="{{ old('name', '') }}" required></td>
                                                    <td><input type="file" name="option_value[image][]" id="image0"
                                                            class="form-control form-control-alternative{{ $errors->has('image') ? ' is-invalid' : '' }}"
                                                            value="{{ old('image', '') }}" required></td>
                                                    <td class="budget"><input type="number" min="1"
                                                            name="option_value[sort_order][]" id="sort_order0"
                                                            value="{{ old('sort_order_image', '') }}"
                                                            class="form-control form-control-alternative{{ $errors->has('sort_order') ? ' is-invalid' : '' }}"
                                                            required></td>
                                                    <td>
                                                        <button class="btn btn-danger" id="DeleteButton">
