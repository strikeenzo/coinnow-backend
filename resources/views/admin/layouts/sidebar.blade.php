...
<!--                                <li class="nav-item">
                    ...
                    @if ($user->hasRole('Admin'))
                        <li class="nav-item">
                            <a class="nav-link" href="#navbar-seller" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-examples">
                                <i class="fas fa-user-tie fa-lg"></i>
                                <span class="nav-link-text" >
                                    {{ __('Seller') }}
                                </span>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-sm flex-column">
                                <div class="collapse" id="navbar-designs">
                                    <li class="nav-item">
                                        <a class="nav-link" href="#navbar-banner" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-examples">
                    ...
                    @if ($user->hasRole('Admin'))
                    <li class="nav-item">
                            <a class="nav-link" href="#navbar-environments" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-examples">
                                <i class="fa fa-history fa-lg"></i>
