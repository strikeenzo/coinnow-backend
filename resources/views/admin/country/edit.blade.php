            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        <a href="{{ route('country.add') }}" class="btn btn-lg btn-neutral fade-class"><i
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('country.update', ['id' => $data->id]) }}" autocomplete="off">
                            @csrf
                            @method('post')

                            <h6 class="heading-small text-muted mb-4">{{ __('Edit Country ') }}</h6>
                            ...
                            <div class="pl-lg-4 row">
                                ...
                                <div class="col-md-4 form-group{{ $errors->has('iso_code_2') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="iso_code_2" id="iso_code_2"
                                        class="form-control form-control-alternative{{ $errors->has('iso_code_2') ? ' is-invalid' : '' }}"
                                        placeholder="{{ __('ISO Code 2') }}"
                                        value="{{ old('iso_code_2', $data->iso_code_2) }}" autofocus>
                                ...
                                <div class="col-md-4 form-group{{ $errors->has('iso_code_3') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="iso_code_3" id="iso_code_3"
                                        class="form-control form-control-alternative{{ $errors->has('iso_code_3') ? ' is-invalid' : '' }}"
                                        placeholder="{{ __('ISO Code 3') }}"
                                        value="{{ old('iso_code_3', $data->iso_code_3) }}" autofocus>
                                ...
                                <div class="col-md-4 form-group{{ $errors->has('address_format') ? ' has-danger' : '' }}">
                                    <label class="form-control-label"
                                        for="address_format">{{ __('Address Format') }}</label>
                                    <input type="text" name="address_format" id="address_format"
                                        class="form-control form-control-alternative{{ $errors->has('address_format') ? ' is-invalid' : '' }}"
                                        placeholder="{{ __('Address Format') }}"
                                        value="{{ old('address_format', $data->address_format) }}" autofocus>
                                ...
                                <div
                                    class="col-md-4 form-group{{ $errors->has('postcode_required') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="postcode_required">{{ __('Post Code') }}</label>
                                    <input type="text" name="postcode_required" id="postcode_required"
                                        class="form-control form-control-alternative{{ $errors->has('postcode_required') ? ' is-invalid' : '' }}"
                                        placeholder="{{ __('Post Code') }}"
                                        value="{{ old('postcode_required', $data->postcode_required) }}" autofocus>
                            ...
                            <div class="pl-lg-4 row">
                                <div class="text-center">
                                    ...
                                    <a href="{{ route('country') }}" type="button"
