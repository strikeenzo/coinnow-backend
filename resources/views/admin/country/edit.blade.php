                        ...
                        <form method="post" action="{{ route('country.update',['id' => $data->id]) }}"  autocomplete="off">
                            ...
                            <div class="pl-lg-4 row">
                                ...
                                <div class="col-md-4 form-group{{ $errors->has('iso_code_2') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="iso_code_2" id="iso_code_2" class="form-control form-control-alternative{{ $errors->has('iso_code_2') ? ' is-invalid' : '' }}" placeholder="{{ __('ISO Code 2') }}" value="{{ old('iso_code_2', $data->iso_code_2) }}" autofocus>
                                ...
                                <div class="col-md-4 form-group{{ $errors->has('iso_code_3') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="iso_code_3" id="iso_code_3" class="form-control form-control-alternative{{ $errors->has('iso_code_3') ? ' is-invalid' : '' }}" placeholder="{{ __('ISO Code 3') }}" value="{{ old('iso_code_3', $data->iso_code_3) }}" autofocus>
                                ...
                                <div class="col-md-4 form-group{{ $errors->has('address_format') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="address_format" id="address_format" class="form-control form-control-alternative{{ $errors->has('address_format') ? ' is-invalid' : '' }}" placeholder="{{ __('Address Format') }}" value="{{ old('address_format', $data->address_format) }}" autofocus>
                                ...
                                <div class="col-md-4 form-group{{ $errors->has('postcode_required') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="postcode_required" id="postcode_required" class="form-control form-control-alternative{{ $errors->has('postcode_required') ? ' is-invalid' : '' }}" placeholder="{{ __('Post Code') }}" value="{{ old('postcode_required', $data->postcode_required) }}" autofocus>
