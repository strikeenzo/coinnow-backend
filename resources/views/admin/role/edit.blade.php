                        ...
                        <form method="post" action="{{ route('role.update',$data->id) }}"  autocomplete="off">
                            ...
                            <div class="pl-lg-4 row">
                                <div class="col-md-4 form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="name" id="input-name" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}"  value="{{ old('name', $data->name) }}" autofocus>
                                    ...
                                    @foreach($val as $key1 => $val1)
                                        ...
                                        <div class="col-md-2 form-group">
                                            <label class="checkbox-inline">
                                                <input type="checkbox" name="permissions[]"  value="{{ "$key.$key1" }}" {{ in_array($customValue,$permissions) ? 'checked' : '' }}> {{ $val1 }}
                                            </label>
                                        </div>
                                    @endforeach
