            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-black d-inline-block">Length Class</h6>
          ...
          <div class="col">
              <div class="card">
                <div class="card-header border-0">
                    ...
                    <form action="{{ route('length-class') }}">
                        <div class="row">
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <a href="{{ route('length-class') }}" class="btn btn-info"><i class="fas fa-sync-alt"></i></a>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="sort" data-sort="name">Unit</th>
                            ...
                            @forelse($records as $key => $value)
                                ...
                                <tr>
                                    ...
                                    <td class="budget">{{ $value->value }}</td>
                                    <td class="budget">{{ $value->unit }}</td>
                                    ...
                                    <td class="">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                <a class="dropdown-item" href="{{ route('length-class.edit',['id' => $value->id]) }}">Edit</a>
                                                <a class="dropdown-item deleteData" type="button"  href="javascript:void(0)" data-url="{{ route('length-class.delete',['id' => $value->id]) }}">Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
