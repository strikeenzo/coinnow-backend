                ...
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('shipping.store') }}"  autocomplete="off">
                            ...
                            <h6 class="heading-small text-muted mb-4">{{ __('Add Shipping ') }}</h6>
                            ...
                            <div class="pl-lg-4 row">
                                ...
                                <div class="col-md-4 form-group{{ $errors->has('shipping_charge') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="shipping_charge" id="input-charge" class="form-control form-control-alternative{{ $errors->has('shipping_charge') ? ' is-invalid' : '' }}" placeholder="{{ __('Shipping Charge') }}" value="{{ old('shipping_charge', '') }}" >
