            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        <a href="{{ route('button.add') }}" class="btn btn-lg btn-neutral fade-class"><i
                                class="fas fa-plus fa-lg"></i> Create/Update</a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <table class="table align-items-center table-flush">
                                ...
                                <tbody>
                                    @forelse($records as $key => $value)
                                        <tr>
                                            <td>{{ $value->type == 1 ? 'Clan' : ($value->type == 2 ? 'Inventory' : ($value->type == 3 ? 'Barn' : 'Job Offers')) }}
                                            </td>
                                            <td class="budget">
                                                @if ($value->image)
                                                    <img src="{{ asset('/public/uploads/button') . '/' . $value->image }}"
                                                        alt="button image" class="img-thumbnail img-fluid"
                                                        style=" width: auto; height: 60px;">
                                                @else
                                                    <img src="{{ asset('/assets/img/default.png') }}" alt="button image"
