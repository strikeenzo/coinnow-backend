            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        <a href="{{ route('pages.add') }}" class="btn btn-lg btn-neutral fade-class"><i class="fas fa-plus fa-lg"></i> New</a>
                        ...
                        <form method="post" action="{{ route('pages.store') }}"  autocomplete="off">
                            ...
                            <div class="pl-lg-4 row">
                                <div class="col-md-6 form-group{{ $errors->has('title') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="title" id="input-title" class="form-control form-control-alternative{{ $errors->has('title') ? ' is-invalid' : '' }}" placeholder="{{ __('Title') }}" value="{{ old('title', '') }}" autofocus required>
                                ...
                                <div class="col-md-6 form-group{{ $errors->has('heading') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="heading" id="address_format" class="form-control form-control-alternative{{ $errors->has('heading') ? ' is-invalid' : '' }}" placeholder="{{ __('Heading') }}" value="{{ old('heading', '') }}" required>
