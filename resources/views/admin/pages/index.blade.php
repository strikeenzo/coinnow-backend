            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-black d-inline-block">Page</h6>
                    ...
                    <form action="{{ route('pages') }}">
                        <div class="row">
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <a href="{{ route('pages') }}" class="btn btn-info"><i class="fas fa-sync-alt"></i></a>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="sort" data-sort="status">Heading</th>
                            ...
                            @forelse($records as $key => $value)
                                <tr>
                                    ...
                                    <td class="budget">{{ $value->heading }}</td>
                                    ...
                                    <td class="">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                <a class="dropdown-item" href="{{ route('pages.edit',['id' => $value->id]) }}">Edit</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
