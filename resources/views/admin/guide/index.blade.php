            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        <a href="{{ route('guide.add') }}" class="btn btn-lg btn-neutral fade-class"><i
                                ...
                                <tbody class="list">
                                    ...
                                    @forelse($records as $key => $value)
                                        <tr>
                                            ...
                                            <td class="budget">
                                                <form method="post" action="{{ route('guide.updateStatus', $value) }}"
                                                    autocomplete="off">
                                                    @csrf
                                                    @method('put')
                                                    <input type="checkbox" name="status"
                                                        {{ $value->status ? 'checked' : '' }} onclick="onChange(this)">
                                                </form>
                                            </td>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                        <a class="dropdown-item"
                                                            href="{{ route('guide.edit', ['id' => $value->id]) }}">Edit</a>
