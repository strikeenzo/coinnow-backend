                            ...
                            <div class="pl-lg-4 row">
                                ...
                                <div class="table-responsive">
                                    <table class="table align-items-center table-flush" id="tbl">
                                        ...
                                        <tbody class="list">
                                            <tr class="tr_clone">
                                                <td class="budget"><input type="text" name="title[]" id="title0"
                                                        class="form-control form-control-alternative{{ $errors->has('title') ? ' is-invalid' : '' }}"
                                                        placeholder="{{ __('Title') }}" value="{{ old('title', '') }}"
                                                        required autofocus></td>
                                                <td class="budget"><input type="text" name="link[]" id="link0"
                                                ...
                                                <td class="budget"> <input type="number" min="1" name="sort_order[]"
                                                        id="sort_order0" value="{{ old('sort_order', '') }}"
