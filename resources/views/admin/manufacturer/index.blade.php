            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        <a href="{{ route('manufacturer.add') }}" class="btn btn-lg btn-neutral fade-class"><i
                        ...
                        <form action="{{ route('manufacturer') }}">
                            <div class="row">
                                ...
                                <div class="col-md-3 form-group">
                                    ...
                                    <a href="{{ route('manufacturer') }}" class="btn btn-info"><i
                            ...
                            <tbody class="list">
                                ...
                                @forelse($records as $key => $value)
                                    <tr>
                                        <td class="budget">
                                            @if ($value->image)
                                                <img src="{{ asset('/public/uploads/manufacturer') . '/' . $value->image }}"
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    <a class="dropdown-item"
                                                        href="{{ route('manufacturer.edit', ['id' => $value->id]) }}">Edit</a>
                                                    <a class="dropdown-item deleteData" type="button"
                                                        href="javascript:void(0)"
                                                        data-url="{{ route('manufacturer.delete', ['id' => $value->id]) }}">Delete</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
