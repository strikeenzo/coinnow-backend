          ...
          <div class="col">
              <div class="card">
                <div class="card-header border-0">
                    ...
                    <form action="{{ route('manufacturer') }}">
                        <div class="row">
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <a href="{{ route('manufacturer') }}" class="btn btn-info"><i class="fas fa-sync-alt"></i></a>
                            </div>
                        </div>
                    </form>
                </div>
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            @forelse($records as $key => $value)
                                ...
                                <tr>
                                  <td class="budget">
                                    @if($value->image)
                                      <img src="{{asset('/public/uploads/manufacturer').'/'.$value->image}}"  alt="{{$value->name}}"  class="img-thumbnail img-fluid" style=" width: 60px;height: 60px;">
                                    @else
                                    ...
                                    <td class="">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                <a class="dropdown-item" href="{{ route('manufacturer.edit',['id' => $value->id]) }}">Edit</a>
                                                <a class="dropdown-item deleteData" type="button"  href="javascript:void(0)" data-url="{{ route('manufacturer.delete',['id' => $value->id]) }}">Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
