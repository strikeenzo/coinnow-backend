        ...
        <div class="row">
                <div class="col-xl-12 order-xl-1">
                    <div class="card bg-secondary shadow">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('manufacturer.update',[ 'id' => $data->id ]) }}" enctype="multipart/form-data" autocomplete="off">
                                @csrf
                                @method('POST')
                                <h6 class="heading-small text-muted mb-4">{{ __('Edit Manufacturer ') }}</h6>
                                ...
                                <div class="pl-lg-4 row">
                                    ...
                                    <div class="col-md-3 form-group">
                                        <img alt="Image placeholder" width="200" height="200" src="{{ url(config('constant.file_path.manufacturer')."/$data->image") }}">
                                    </div>
