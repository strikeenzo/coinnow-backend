        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('stock-status.update',['id' => $data->id ]) }}"  autocomplete="off">
                            @csrf
                            @method('post')
                            ...
                            <div class="pl-lg-4 row">
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="{{ route('stock-status') }}" type="button" class="btn btn-danger mt-4">{{ __('Cancel') }}</a>
                                </div>
                            </div>
                        </form>
                    </div>
