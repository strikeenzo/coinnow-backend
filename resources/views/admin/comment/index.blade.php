                        ...
                        <form action="{{ route('comments') }}">
                            <div class="row">
                                ...
                                <div class="col-md-3 form-group">
                                    ...
                                    <a href="{{ route('comments') }}" class="btn btn-info"><i class="fas fa-sync-alt"></i></a>
                                </div>
                            </div>
                        </form>
                    </div>
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            @forelse($records as $key => $value)
                                ...
                                <tr>
                                    ...
                                    <td style="word-break: break-word; white-space: break-spaces;" class="p-3">{{ $value->content }}</td>
                                    <td style="word-break: break-word; white-space: break-spaces;" class="budget p-3">{{ $value['customer']->email }}</td>
                                    <td style="word-break: break-word; white-space: break-spaces;" class="p-3">{{ $value->reply }}</td>
                                    <td style="word-break: break-word; white-space: break-spaces;" class="budget p-3" style="width: 70px;">{{ $value->created_at }}</td>
                                    <td style="word-break: break-word; white-space: break-spaces;" class="budget p-3" style="width: 70px ">{{ $value->reply_at }}</td>
                                    <td class="p-3">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                <a class="dropdown-item" href="{{ route('comments.edit', $value->id) }}">Reply</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
