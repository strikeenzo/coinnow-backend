        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('tax-rate.store') }}"  autocomplete="off">
                            @csrf
                            @method('post')
                            ...
                            <div class="pl-lg-4 row">
                                ...
                                <div class="col-md-4 form-group{{ $errors->has('rate') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="rate" id="rate" class="form-control form-control-alternative{{ $errors->has('rate') ? ' is-invalid' : '' }}" placeholder="{{ __('Rate') }}" value="{{ old('rate', '') }}" autofocus>
