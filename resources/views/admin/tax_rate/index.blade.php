            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-black d-inline-block">Tax Rate</h6>
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        <a href="{{ route('tax-rate.add') }}" class="btn btn-lg btn-neutral fade-class"><i class="fas fa-plus fa-lg"></i> New</a>
                        ...
                        <form action="{{ route('tax-rate') }}">
                            <div class="row">
                                ...
                                <div class="col-md-3 form-group">
                                    ...
                                    <a href="{{ route('tax-rate') }}" class="btn btn-info"><i class="fas fa-sync-alt"></i></a>
                                </div>
                            </div>
                        </form>
                    </div>
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            @forelse($records as $key => $value)
                                ...
                                <tr>
                                    ...
                                    <td class="budget">{{ $value->rate }}</td>
                                    <td class="budget">{{ config('constant.tax_type')[$value->type] }}</td>
                                    ...
                                    <td class="">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                <a class="dropdown-item" href="{{ route('tax-rate.edit',['id' => $value->id]) }}">Edit</a>
                                                <a class="dropdown-item deleteData" type="button"  href="javascript:void(0)" data-url="{{ route('tax-rate.delete',['id' => $value->id]) }}">Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
