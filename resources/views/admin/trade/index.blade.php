            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        <a href="{{ route('trade.add') }}" class="btn btn-lg btn-neutral fade-class"><i
                                        ...
                                        @forelse($trade as $value)
                                            <div class="row my-4">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <span class="h2  mb-0">{{ $value->min_reward }} -
                                                        {{ $value->max_reward }}</span>
                                                </div>
                                                <div class="col">
                                                ...
                                                <div class="col-auto align-middle">
                                                    <img src="{{ asset('/public/uploads/trade') . '/' . $value->image }}"
                                                        alt="product" class="img-thumbnail img-fluid"
