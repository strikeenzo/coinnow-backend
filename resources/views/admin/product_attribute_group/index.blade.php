            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-black d-inline-block">Attribute Group</h6>
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                <li class="breadcrumb-item"><a href={{ route('dashboard') }}><i class="fas fa-home"></i></a>
                                </li>
                                <li class="breadcrumb-item"><a href="{{ route('product-attribute-group') }}">Attribute
                                        Group</a></li>
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        <a href="{{ route('product-attribute-group.add') }}" class="btn btn-lg btn-neutral fade-class"><i
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header border-0">
                        ...
                        <form action="{{ route('product-attribute-group') }}">
                            <div class="row">
                                ...
                                <div class="col-md-3 form-group">
                                    ...
                                    <a href="{{ route('product-attribute-group') }}" class="btn btn-info"><i
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    <a class="dropdown-item"
                                                        href="{{ route('product-attribute-group.edit', ['id' => $value->id]) }}">Edit</a>
                                                    <a class="dropdown-item deleteData" type="button"
                                                        href="javascript:void(0)"
                                                        data-url="{{ route('product-attribute-group.delete', ['id' => $value->id]) }}">Delete</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
