    ...
    <div class="pl-lg-4 row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" name="shipping_firstname" id="shipping_firstname"
                    value="{{ isset($order->shipping_firstname) ? $order->shipping_firstname : '' }}"
                    class="form-control" />
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" name="shipping_lastname" id="shipping_lastname"
                    value="{{ isset($order->shipping_lastname) ? $order->shipping_lastname : '' }}"
                    class="form-control" />
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" name="shipping_company" id="shipping_company"
                    value="{{ isset($order->shipping_company) ? $order->shipping_company : '' }}"
                    class="form-control" />
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" name="shipping_address_1" id="shipping_address_1"
                    value="{{ isset($order->shipping_address_1) ? $order->shipping_address_1 : '' }}"
                    class="form-control" />
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" name="shipping_address_2" id="shipping_address_2"
                    value="{{ isset($order->shipping_address_2) ? $order->shipping_address_2 : '' }}"
                    class="form-control" />
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" name="shipping_city" id="shipping_city"
                    value="{{ isset($order->shipping_city) ? $order->shipping_city : '' }}" class="form-control" />
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" name="shipping_postcode" id="shipping_postcode"
                    value="{{ isset($order->shipping_postcode) ? $order->shipping_postcode : '' }}"
                    class="form-control" />
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="shipping_country_id" name="shipping_country_id">
                    ...
                    @foreach ($data['country'] as $key => $value)
                        <option value={{ $key }}
                            {{ isset($order->shipping_country_id) && $order->shipping_country_id == $key ? 'selected' : '' }}>
                            {{ $value }}</option>
                    @endforeach
                </select>
            </div>
