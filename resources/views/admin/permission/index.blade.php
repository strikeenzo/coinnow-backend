            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        <a href="{{ route('permission.add') }}" class="btn btn-lg btn-neutral fade-class"><i class="fas fa-plus fa-lg"></i> New</a>
                        ...
                        <form action="{{ route('permission') }}">
                            <div class="row">
                                ...
                                <div class="col-md-3 form-group">
                                    ...
                                    <a href="{{ route('permission') }}" class="btn btn-info"><i class="fas fa-sync-alt"></i></a>
                                </div>
                            </div>
                        </form>
                    </div>
...
{{--                                <th scope="col" class="sort">Action</th>--}}
                            ...
                            @forelse($records as $key => $value)
                                <tr>
                                    <td class="budget">{{ getPermissionGroupName($value->name) }}</td>
                                    <td class="budget">{{ $value->display_name }}</td>
{{--                                    <td class="">--}}
{{--                                        <div class="dropdown">--}}
...
{{--                                                <a class="dropdown-item" href="{{ route('permission.edit',['id' => $value->id]) }}">Edit</a>--}}
{{--                                                <a class="dropdown-item deleteData" type="button"  href="javascript:void(0)" data-url="{{ route('permission.delete',['id' => $value->id]) }}">Delete</a>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                    </td>--}}
                                </tr>
