                            ...
                            <form method="post" action="{{ route('category.store') }}" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="pl-lg-4 row">
                                    ...
                                    <div class="col-md-6 form-group{{ $errors->has('meta_title') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="meta_title" id="meta_title" class="form-control form-control-alternative{{ $errors->has('meta_title') ? ' is-invalid' : '' }}" placeholder="{{ __('Meta Title') }}" value="{{ old('meta_title', '') }}" autofocus>
                                    ...
                                    <div class="col-md-6 form-group{{ $errors->has('meta_keyword') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="meta_keyword" id="meta_keyword" class="form-control form-control-alternative{{ $errors->has('meta_keyword') ? ' is-invalid' : '' }}" placeholder="{{ __('Meta Keyword') }}" value="{{ old('meta_keyword', '') }}" autofocus>
                                    ...
                                    <div class="col-md-6 form-group{{ $errors->has('meta_description') ? ' has-danger' : '' }}">
                                        ...
                                        <textarea name="meta_description" id="meta_description" class="form-control form-control-alternative{{ $errors->has('meta_description') ? ' is-invalid' : '' }}" placeholder="{{ __('Meta Description') }}" value="{{ old('meta_description', '') }}" rows="3"></textarea>
                                    ...
                                    <div class="col-md-6 form-group{{ $errors->has('sort_order') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="number" min="1" name="sort_order" id="sort_order" value="{{ old('sort_order', '') }}" class="form-control form-control-alternative{{ $errors->has('sort_order') ? ' is-invalid' : '' }}" autofocus>
                                    ...
                                    <div class="col-md-6 form-group{{ $errors->has('image') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="file" name="image" id="input-email" class="form-control form-control-alternative{{ $errors->has('image') ? ' is-invalid' : '' }}" value="{{ old('image', '') }}" required>
