        ...
        <div class="row">
                <div class="col-xl-12 order-xl-1">
                    <div class="card bg-secondary shadow">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('category.update',[ 'id' => $data->category_id ]) }}" enctype="multipart/form-data" autocomplete="off">
                                @csrf
                                @method('POST')
                                ...
                                <div class="pl-lg-4 row">
                                    ...
                                    <div class="col-md-6 form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="name" id="input-name" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Name') }}" value="{{ old('name', $data->categoryDescription->name) }}" autofocus>
                                    ...
                                    <div class="col-md-6 form-group{{ $errors->has('meta_title') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="meta_title" id="meta_title" class="form-control form-control-alternative{{ $errors->has('meta_title') ? ' is-invalid' : '' }}" placeholder="{{ __('Meta Title') }}" value="{{ old('meta_title', $data->categoryDescription->meta_title) }}" autofocus>
                                    ...
                                    <div class="col-md-6 form-group{{ $errors->has('meta_keyword') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="meta_keyword" id="meta_keyword" class="form-control form-control-alternative{{ $errors->has('meta_keyword') ? ' is-invalid' : '' }}" placeholder="{{ __('Meta Keyword') }}" value="{{ old('meta_keyword', $data->categoryDescription->meta_keyword) }}" autofocus>
                                    ...
                                    <div class="col-md-6 form-group{{ $errors->has('meta_description') ? ' has-danger' : '' }}">
                                        ...
                                        <textarea name="meta_description" id="meta_description" class="form-control form-control-alternative{{ $errors->has('meta_description') ? ' is-invalid' : '' }}" placeholder="{{ __('Meta Description') }}" rows="3">{{ old('meta_description', $data->categoryDescription->meta_description) }} </textarea>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <a href="{{ route('category') }}" type="button" class="btn btn-danger mt-4">{{ __('Cancel') }}</a>
                                    </div>
                                </div>
                            </form>
                        </div>
