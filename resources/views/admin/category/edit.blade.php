        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('category.update', ['id' => $data->category_id]) }}"
                            ...
                            <div class="pl-lg-4 row">
                                <div class="col-md-6 form-group{{ $errors->has('parent_id') ? ' has-danger' : '' }}">
                                    ...
                                    <select class="form-control" name="parent_id">
                                        ...
                                        @foreach ($parentCategory as $key => $value)
                                            <option value="{{ $key }}"
                                                {{ $key == $data->parent_id ? 'selected' : '' }}>{{ $value }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6 form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="name" id="input-name"
                                        ...
                                        placeholder="{{ __('Name') }}"
                                        value="{{ old('name', $data->categoryDescription->name) }}" autofocus>
                                ...
                                <div class="col-md-6 form-group{{ $errors->has('meta_title') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="meta_title" id="meta_title"
                                        ...
                                        value="{{ old('meta_title', $data->categoryDescription->meta_title) }}" autofocus>
                                ...
                                <div class="col-md-6 form-group{{ $errors->has('meta_keyword') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="meta_keyword" id="meta_keyword"
                                        ...
                                        value="{{ old('meta_keyword', $data->categoryDescription->meta_keyword) }}"
                                        autofocus>
                                ...
                                <div
                                    ...
                                    <textarea name="meta_description" id="meta_description"
                                        ...
                                        placeholder="{{ __('Meta Description') }}" rows="3">{{ old('meta_description', $data->categoryDescription->meta_description) }} </textarea>
                                ...
                                <div class="col-md-3 form-group">
                                    <img alt="Image placeholder" width="200" height="200"
                                        src="{{ url(config('constant.file_path.category') . "/$data->image") }}">
                                </div>
