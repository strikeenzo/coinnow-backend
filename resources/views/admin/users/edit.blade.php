            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        <a href="{{ route('user.add') }}" class="btn btn-lg btn-neutral fade-class"><i class="fas fa-plus fa-lg"></i> New</a>
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('user.update',['id' => $data->id]) }}"  autocomplete="off">
                            @csrf
                            @method('post')

                            <h6 class="heading-small text-muted mb-4">{{ __('Edit User ') }}</h6>
                            ...
                            <div class="pl-lg-4 row">
                                ...
                                <div class="col-md-4 form-group{{ $errors->has('mobile') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="mobile" id="mobile" class="form-control form-control-alternative{{ $errors->has('mobile') ? ' is-invalid' : '' }}" placeholder="{{ __('Mobile Number') }}" value="{{ old('mobile', $data->mobile) }}" autofocus>
...
{{--                                    <input type="password" name="confirmed" id="confirmed" class="form-control form-control-alternative{{ $errors->has('confirmed') ? ' is-invalid' : '' }}" placeholder="{{ __('Confirmed') }}" value="" autofocus>--}}
